      ...
      {mostrarFormulario && (
        <div className="bg-white rounded-xl shadow p-4 sm:p-6 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <input className="border rounded-lg px-4 py-2 text-sm text-gray-800 bg-white sm:col-span-2" placeholder="Descripción del trabajo" value={nuevo.descripcion} onChange={(e) => setNuevo({ ...nuevo, descripcion: e.target.value })} />
            <input className="border rounded-lg px-4 py-2 text-sm text-gray-800 bg-white sm:col-span-2" placeholder="Observaciones (opcional)" value={nuevo.observaciones} onChange={(e) => setNuevo({ ...nuevo, observaciones: e.target.value })} />
          </div>
